	...
	<div class="container">
		...
		<div class="articles">
			<article class="articles-article">
				<h3 class="articles__article-header"><?= $article['title']?></h3>
				<em class="articles__article-date">Опубликовано <?= $article['date']?></em>
				<p class="articles__article-content"><?= $article['content']?></p>
			</article>
		</div>
		<footer class="footer">
